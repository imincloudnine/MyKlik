    ...
    <section className="py-20 px-4">
      <div className="mx-auto max-w-7xl space-y-12">
        <div className="flex flex-col lg:flex-row items-center gap-12 bg-white rounded-2xl p-8 shadow-[0_0_20px_rgba(0,0,0,0.1)]">
          <img src="src/assets/Box2.png" className="w-full lg:w-[616px] h-[347px] object-cover rounded-xl" alt="Fast Internet" />
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-12 bg-white rounded-2xl p-8 shadow-[0_0_20px_rgba(0,0,0,0.1)]">
          <img src="src/assets/Box1.png" className="w-full lg:w-[616px] h-[347px] object-cover rounded-xl" alt="Upgrade" />
          <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 bg-white rounded-2xl p-8 shadow-[0_0_20px_rgba(0,0,0,0.1)]">
          <img src="src/assets/Box3.png" className="w-full lg:w-[616px] h-[347px] object-cover rounded-xl" alt="Daftar" />
          <div className="space-y-6">
